	...
	public Edit_client() {
		getRootPane().getInputMap(JComponent.WHEN_IN_FOCUSED_WINDOW).put(
		 ...
		 Dimension screenSize = Toolkit.getDefaultToolkit().getScreenSize();
			...
			JLabel lblAddClient = new JLabel("Edit Client");
			...
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					...
					else
					{
						...
						String query="update Client set Address3 = '"+address3.getText()+"',Address1='"+address1.getText()+"',Address2='"+address2.getText()+"',City='"+city.getSelectedItem().toString()+"',State='"+state.getSelectedItem().toString()+"',Mobile='"+mobile.getText()+"',Email='"+email.getText()+"',GST='"+gst.getText()+"',Pan_no='"+pan.getText()+"',Website='"+website.getText()+"',Mobile1='"+mobile1.getText()+"',Landline='"+landline.getText()+"',Landline1='"+landline1.getText()+"' where ID='"+company+"'";
