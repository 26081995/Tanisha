...
public class Edit_order extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Edit_order frame = new Edit_order();
	...
	public Edit_order() {
		...
		JLabel lblQuotation = new JLabel("Edit order");
		...
		lblClientCategory.setBounds(7, 56, 135, 25);
		...
		client_name.setBounds(138, 56, 823, 25);
		...
		try
		{
			 String query11="delete from Order_temp1";
             PreparedStatement pmt11 = connection.prepareStatement(query11);
             pmt11.executeUpdate();
             pmt11.close();
             
             String query12="select * from Order_temp1";
				...
				try
				{
					...
					else
					{
						...
						try
						{
							...
							try
							{
								String query1q = "delete from Order_detail where S_id="+id99;
			                ...
			                String query0 = "select * from Order_temp1";
		                    ...
		                    String query12="update order1 set Date='"+chadate.getText()+"',Transport_type='"+driver_type.getSelectedItem().toString()+"',Driver_name='"+driver_name.getSelectedItem().toString()+"',Driver_amount='"+driver_amount.getText()+"',Remark='"+remark.getText()+"',Total='"+total.getText()+"' where ID='"+id99+"'";
		                    ...
		                    {
		                        String querydetais="insert into Order_detail (S_id, Product,Rate,Qty,Total) VALUES ('"+id99+"','"+product1.get(i)+"','"+dc.format(Double.parseDouble(rate1.get(i)))+"','"+dc.format(Double.parseDouble(qty1.get(i)))+"','"+dc.format(Double.parseDouble(total1.get(i)))+"')";
			...
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					...
					else
					{
                        ...
                        int mi=0;
                		String query1 = "select * from Order_temp1";
					    ...
					    String query11="insert into Order_temp1 (ID,Product,Rate,Qty,Total) VALUES ('"+mi+"','"+product.getSelectedItem().toString()+"','"+rate.getText()+"','"+qty.getText()+"','"+dc.format(a)+"')";
	                      PreparedStatement pmt11 = connection.prepareStatement(query11);
	                      pmt11.executeUpdate();
	                      pmt11.close();
...
*/
	                      double k=0;
	                      String query13 = "select sum(Total) as k1 from Order_temp1";
...
*/
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					String query11="delete from Order_temp1 where ID='"+id+"'";
                    PreparedStatement pmt11 = connection.prepareStatement(query11);
                    pmt11.executeUpdate();
                    pmt11.close();
		...
		try
		{
			String query13 = "select * from Order_id";
		    PreparedStatement pmt13 =  connection.prepareStatement(query13);
		    ResultSet rs13 = pmt13.executeQuery();
		    while(rs13.next())
		    {
            ...
            String query0 = "select * from Order_detail where S_id='"+id99+"'";
            PreparedStatement pmt0 = connection.prepareStatement(query0);
            ResultSet rs0 = pmt0.executeQuery();
            while(rs0.next())
            {
            ...
            for(int i=0; i<product1.size();i++)
            {
                String querydetais="insert into Order_temp1 (ID, Product,Rate,Qty,Total) VALUES ('"+(i+1)+"','"+product1.get(i)+"','"+dc.format(Double.parseDouble(rate1.get(i)))+"','"+dc.format(Double.parseDouble(qty1.get(i)))+"','"+dc.format(Double.parseDouble(total1.get(i)))+"')";
                PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
                pmtdetails.executeUpdate();
                pmtdetails.close();
            }
