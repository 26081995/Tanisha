...
public class Edit_purchase extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Edit_purchase frame = new Edit_purchase();
	...
	public Edit_purchase() {
		...
		JLabel lblQuotation = new JLabel("Edit Purchase");
		lblQuotation.setFont(new Font("Book Antiqua", Font.BOLD, 25));
		lblQuotation.setBounds(410, 10, 171, 25);
		...
		creditor_name.setEnabled(false);
		...
		cgst.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent arg0) {
				try
				{
                    ...
                    String query13 = "select sum(Total) as k1 from Purchase_temp1";
		...
		try
		{
			 String query11="delete from Purchase_temp1";
             PreparedStatement pmt11 = connection.prepareStatement(query11);
             pmt11.executeUpdate();
             pmt11.close();
             
             String query12="select * from Purchase_temp1";
					...
					else
					{
						...
						try
						{
							try
							{
								...
								String query1 = "select * from Purchase where  Company='"+company+"' and ID='"+id99+"'";
				                ...
				                String query0 = "select * from Purchase_detail where S_id='"+id99+"'";
			                    ...
			                    for(int i=0; i<product11.size();i++)
			                    {
			                        ...
			                        String query1232="update Product set Stock=Stock - '"+qty11.get(i)+"' where Name='"+product11.get(i)+"' and Company='"+company+"'";
				                    PreparedStatement pmt1232 = connection.prepareStatement(query1232);
				                    pmt1232.executeUpdate();
			                    }
								
			                    String query = "delete from Purchase_detail where ID="+id99;
			                ...
			                String query0 = "select * from Purchase_temp1";
		                    PreparedStatement pmt0 = connection.prepareStatement(query0);
		                    ResultSet rs0 = pmt0.executeQuery();
		                    while(rs0.next())
		                    {
		                    ...
		                    String query12="update Purchase set Date='"+chadate.getText()+"',CGST='"+cgst.getText()+"',SGST='"+sgst.getText()+"',IGST='"+igst.getText()+"',Remark='"+remark.getText()+"',Total='"+total.getText()+"' where ID='"+id99+"'";
			...
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					...
					else
					{
                        ...
                        int mi=0;
                		String query1 = "select * from Purchase_temp1";
					    PreparedStatement pmt1 =  connection.prepareStatement(query1);
					    ResultSet rs1 = pmt1.executeQuery();
					    while(rs1.next())
					    {
					    ...
					    String query11="insert into Purchase_temp1 (ID,Product,Rate,Qty,Total) VALUES ('"+mi+"','"+product.getSelectedItem().toString()+"','"+rate.getText()+"','"+qty.getText()+"','"+dc.format(a)+"')";
	                      PreparedStatement pmt11 = connection.prepareStatement(query11);
	                      pmt11.executeUpdate();
	                      pmt11.close();
...
*/
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try
				{
					String query11="delete from Purchase_temp1 where ID='"+id+"'";
                    PreparedStatement pmt11 = connection.prepareStatement(query11);
                    pmt11.executeUpdate();
                    pmt11.close();
		...
		try
		{
			String query13 = "select * from Purchase_id";
		    PreparedStatement pmt13 =  connection.prepareStatement(query13);
		    ResultSet rs13 = pmt13.executeQuery();
		    while(rs13.next())
		    {
            ...
            for(int i=0; i<product1.size();i++)
            {
                String querydetais="insert into Purchase_temp1 (ID, Product,Rate,Qty,Total) VALUES ('"+(i+1)+"','"+product1.get(i)+"','"+dc.format(Double.parseDouble(rate1.get(i)))+"','"+dc.format(Double.parseDouble(qty1.get(i)))+"','"+dc.format(Double.parseDouble(total1.get(i)))+"')";
                PreparedStatement pmtdetails = connection.prepareStatement(querydetais);
                pmtdetails.executeUpdate();
                pmtdetails.close();
            }
            ...
            String query01 = "select * from Purchase where ID='"+id99+"'";
            PreparedStatement pmt01 = connection.prepareStatement(query01);
            ResultSet rs01 = pmt01.executeQuery();
            while(rs01.next())
            {
           	 	purchase_no.setText(rs01.getString("Purchase_no"));
           	 	creditor_name.setSelectedItem(rs01.getString("Name"));
